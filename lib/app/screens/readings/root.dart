...
class ReadingsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final scrollController = ScrollController(); // Create a unique ScrollController

    return Scrollbar(
      controller: scrollController, // Provide the created ScrollController
      child: ListView.builder(
        controller: scrollController, // Provide the same ScrollController here
